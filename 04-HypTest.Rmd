...
```{r chinesercfig,echo=FALSE,angle=-90,fig.height=2,fig.width=3,dev='pdf',fig.cap="\\label{fig:chineserc} An example of subjects vs. object relative clauses in Chinese."}
