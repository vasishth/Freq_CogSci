...
Here, we turn to a closely related test: the *likelihood ratio test statistic*. The reason for considering this alternative test is that in reality we will almost never use the t-test as described above.
