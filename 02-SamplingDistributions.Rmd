...
:::: {.blackbox data-latex=""}
::: {data-latex=""}
**Proof that the p-value is uniformly distributed under the null**
:::
...
SRdatabyitem <- subset(byitem,
                       condition == "subjgap")$rawRT
ORdatabyitem <- subset(byitem,
                       condition == "objgap")$rawRT
