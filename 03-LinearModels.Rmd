...
The less data we have from a given subject, or the more extreme the data from a given subject relative to the entire data set, the greater the shrinkage. Figure \@ref(fig:shrinkage) illustrates this. 
