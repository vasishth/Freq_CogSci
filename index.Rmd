...
The entire book, including all data and source code, is available online for free on [https://github.com/vasishth/frequentist_book](https://github.com/vasishth/frequentist_book). The exercise solutions are provided there as a pdf (to-do).
