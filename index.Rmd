...
Before you start, please install
  ...
  - The R packages `MASS`, `dplyr`, `purrr`, `readr`, `extraDistr`, `ggplot2`, `bivariate`,`intoo`,`barsurf`, `SIN`, `kableExtra`, `tidyverse`,`hypr`,`designr`
    - These can be installed in the usual way: `install.packages(c("MASS", "dplyr", "purrr", "readr", "extraDistr", "ggplot2","bivariate","intoo","barsurf","SIN","kableExtra","tidyverse","hypr","designr"))`. 
